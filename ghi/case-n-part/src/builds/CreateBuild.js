...
function CreateBuild() {
  ...
  return (
    <div className='container my-5'>
      {build !== undefined && (
        <div className='row py-5 g-4 mt-4 mx-4'>
          <form onSubmit={handleSubmit} id='create-build-form'>
            <div className='row justify-content-md-center'>
              ...
              <div className='col-md-10 col-lg-auto mt-sm-2'>
                <input
                  ...
                  name='name'
                  id='name'
                  className='form-control w-lg-100 w-lg-100 mb-2 bg-dark text-white border-secondary'
                />
                <select
                  ...
                  name='color'
                  id='color'
                  className='form-select w-md-75 w-sm-100 mb-2 bg-dark text-white border-secondary'
                  required
                >
                ...
                <select
                  ...
                  name='size'
                  id='size'
                  className='form-select w-md-75 w-sm-100 bg-dark text-white border-secondary'
                  required
                >
                ...
                <div className='col-md-auto w-lg-75 w-md-100 pt-2'>
                  <button
                    type='button'
                ...
                <div className='col-md-auto w-md-75 w-sm-100 pt-2'>
                  <button
                    type='button'
                    className='btn btn-outline-secondary w-100'
                ...
                <div className='col-md w-md-75 w-sm-100 pt-2'>
              ...
              <div className='row justify-content-md-center m-0 p-0'>
